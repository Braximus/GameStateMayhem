...
class CometWarsData
{
	...
	std::map<CW::Object_Speed, float>					mSpeed;	
	std::map<CW::Components_size, sf::Vector2f>			mSizes;	
	std::map<CW::AsteroidType, sf::IntRect>				mComet_Texture_rects;	
...
public:
	...
	//	Getter Functions
	const CW::SubStates					getCurrentSubState() const;
